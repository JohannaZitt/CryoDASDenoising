...
experiments = ["03_accumulation_horizontal"]
for experiment in experiments:
    ...
    for i, id in enumerate(ids):
        ...
        cmap = "plasma"# "plasma" # verschiednene colormaps:  cividis, plasma, inferno, viridis, magma, (cmocean.cm.curl, seismic)
        t_start_das = 0
        ...
        """ Plotting Wiggle comparison - old colors 
        col_pink = "#CE4A75"
        col1 = "#3C049B"
        col4 = "#C7427C"
        if id == 82:
            ...
            t_start_wiggle = 270
            t_end_wiggle = 430
        axs[i, 3].plot(raw_data_norm[middle_channel][t_start_wiggle:t_end_wiggle], 
                       color="grey", label="Noisy", linewidth=1.5, alpha=0.6, zorder=1)
        axs[i, 3].plot(denoised_data_norm[middle_channel][t_start_wiggle:t_end_wiggle], 
                       color="black", label="Denoised", linewidth=1.5, alpha=0.8, zorder=1)
        axs[i, 3].plot(seis_data[t_start_wiggle:t_end_wiggle], 
                       color=col_pink, label="Co-Located Seismometer", linewidth=1.5, alpha=0.8, zorder=1)
        axs[i, 3].set_yticks([])
        ax2 = axs[i, 3].twinx()
        ...
        if id == 82:
            ...
            t_end_wiggle = 430
        axs[i, 3].plot(raw_data_norm[middle_channel][t_start_wiggle:t_end_wiggle],
                       color=col_purple, label="Noisy", linewidth=1.5, alpha=0.7, zorder=1)
        axs[i, 3].plot(denoised_data_norm[middle_channel][t_start_wiggle:t_end_wiggle],
